...
async def upstream(ups):
    ...
    off_repo = 'https://github.com/zakaryan2004/Telegram-Paperplane.git'
    ...
    if HEROKU_APIKEY != None:
        ...
        await ups.edit("`Heroku configuration found! Updater will try to update and restart automatically if succeeded.`")
        ...
        heroku_remote_url = heroku_app.git_url.replace("https://", f"https://api:{HEROKU_APIKEY}@")
